...
final class ViewBuilder: NSObject {
    ...
    func getCard() {
        ...
        NSLayoutConstraint.activate([
            ...
            card.topAnchor.constraint(equalTo: pageTitle.bottomAnchor, constant: 40)
        ])
    }
    ...
    func setIconSlider() {
        let iconTitle = manager.slideTitle(titleText: "Add shapes")
        ...
        view.addSubview(iconTitle)
        view.addSubview(imageCollection)
        
        NSLayoutConstraint.activate([
            
            iconTitle.topAnchor.constraint(equalTo: colorCollection.bottomAnchor, constant: 40),
            iconTitle.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            iconTitle.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
            
            imageCollection.topAnchor.constraint(equalTo: iconTitle.bottomAnchor, constant: 20),
